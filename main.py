...
def main():
    ...
    parser.add_argument(
        "DATA_ROOT", help="Location to root directory for dataset reading"
    )  # /mnt/mars-fast/datasets/
    parser.add_argument(
        "SAVE_ROOT", help="Location to root directory for saving checkpoint models"
    )  # /mnt/mars-alpha/
    parser.add_argument(
        "MODEL_PATH",
        help="Location to root directory where kinetics pretrained models are stored",
    )
    parser.add_argument(
        "--ANNO_ROOT",
        default="",
        help="Location to directory where annotations are stored",
    )  # /mnt/mars-fast/datasets/
    parser.add_argument(
        "--MODE",
        default="train",
    ...
    if args.MODE in ["train", "val"]:
        ...
        train_dataset = VideoDataset(
            args, train=True, skip_step=train_skip_step, transform=train_transform
        )
